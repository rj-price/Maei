...
Run_find_small_ORFs=/home/u1983390/Scripts/find_all_ORF_from_getorf.py           #Path to find_all_ORF_from_getorf.py script
...
for i in $(cat ${gL}); do
  ...
  bedtools getfasta -s -fi ${i} -bed ${i}_mimp_hits.sorted.2500.bed -fo ${i}_mimp_hits.2500.fasta; done
