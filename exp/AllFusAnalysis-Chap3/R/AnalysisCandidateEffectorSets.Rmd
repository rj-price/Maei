...
Now, I need to prepare the heatmap data. As we are looking at clustered (0.65% ID, cd-hit (v...)) and filtered sequences (SignalP (v5.06) and EffectorP (v2.0.1) extracted from BLAST hits, the total number of candidate effectors per cluster per isolate varies, but I want to just look at Presence/Absence. In order to do this, I converted the heatmap data matrix to a binary data frame. 
