...
```{r final heatmap, fig.height= 15, fig.width= 25}
...
I also wanted to look at the distribution of the these clusters in numerical terms. How many are shared among all assemblies? How many are shared among all Fo. assemblies? How many core CECs are there in cubense? etc. 
