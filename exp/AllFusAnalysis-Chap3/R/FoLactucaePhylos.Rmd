...
```{r SIX8 tree, results= 'hide', fig.height= 20, fig.width= 10}
...
```{r TEF1a tree plot, fig.height= 15, fig.width= 10, fig.cap="SIX8 phylogeny of Fusarium isolates included int effector anaylisis.The tree is rooted through Foly reference."}
# plot it 
plot(p4)
...
```{r SIX9 tree plot, fig.height= 20, fig.width= 12, fig.cap="SIX9 phylogeny of Fusarium isolates included int effector anaylisis.The tree is rooted through Foly reference."}
# plot it 
plot(p4)
...
```{r prep SIX14 tree, fig.width= 20}
# ---- Prepare the tree ---- #
# Read the phylogenetic tree from the Newick file
...
```{r SIX14 tree, results= 'hide', fig.height= 20, fig.width= 10}
...
```{r SIX14 tree plot, fig.height= 20, fig.width= 12, fig.cap="SIX14 phylogeny of Fusarium isolates included int effector anaylisis.The tree is rooted through Foly reference."}
# plot it 
plot(p4)
